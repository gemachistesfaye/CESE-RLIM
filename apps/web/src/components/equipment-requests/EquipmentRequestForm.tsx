        ...
        <div className="bg-slate-50 rounded-lg p-3 text-sm">
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <span className="text-slate-900">{selectedEquipment.category}</span>
            </div>
            <div>
              <span className="text-slate-500">Condition:</span>{" "}
              <span className="text-slate-900">{selectedEquipment.condition}</span>
            </div>
            <div>
              <span className="text-slate-500">Laboratory:</span>{" "}
              <span className="text-slate-900">{selectedEquipment.laboratory.name}</span>
            </div>
            <div>
              <span className="text-slate-500">Location:</span>{" "}
              <span className="text-slate-900">{selectedEquipment.laboratory.location}</span>
            </div>
          </div>
        </div>
      )}
