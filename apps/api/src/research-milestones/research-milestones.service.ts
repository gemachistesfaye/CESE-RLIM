  ...
  async create(dto: CreateResearchMilestoneDto, userId: string) {
    ...
    const milestone = await this.prisma.researchMilestone.create({
      data: {
        ...
        actualCompletionDate: dto.actualCompletionDate ? new Date(dto.actualCompletionDate) : null,
        deliverableLink: dto.deliverableLink || null,
        createdById: userId,
  ...
  async update(id: string, dto: UpdateResearchMilestoneDto, userId: string) {
    ...
    const milestone = await this.prisma.researchMilestone.update({
      ...
      data: {
        ...
        ...(dto.actualCompletionDate !== undefined && { actualCompletionDate: dto.actualCompletionDate ? new Date(dto.actualCompletionDate) : null }),
        ...(dto.deliverableLink !== undefined && { deliverableLink: dto.deliverableLink || null }),
      },
      select: MILESTONE_SELECT,
    });
